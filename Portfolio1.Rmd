...
# 4: Modeling
Often, models are used to understand how an independent variable affects a dependent variable. In this situation, logistic regression was used to determine if the probability for loan approval was different for non-minorities and minorities when income and loan amount is eqaul.
